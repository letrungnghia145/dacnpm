package com.app.config.constant.url;

public class BaseURL {
	public static final String BASE_URL = "/api";
	public static final String POST_BASE_URL_V1 = BASE_URL + "/v1/posts";
	public static final String CATEGORY_BASE_URL_V1 = BASE_URL + "/v1/categories";
